#!/bin/bash
# Launch RViz2 for live DG-KILO visualization from a desktop-side Humble container.
#
# Usage:
#   bash scripts/dgkilo/live_rviz.sh [--iface <desktop_interface>] [--config <rviz_config>]
#
# Example:
...
RVIZ_CFG_DEFAULT="$REPO_ROOT/config/dgkilo/dg_kilo.rviz"
